// cuelume 0.2.2 — vendored (github.com/Danilaa1/cuelume, MIT). Flattened from
// its ESM dist into one IIFE exposing window.cuelume = { play, bind, setEnabled, setVolume, sounds }.
(function(){
/**
...
window.cuelume = { play: play, bind: bind, setEnabled: setEnabled, setVolume: (typeof setVolume!=='undefined'?setVolume:function(){}), sounds: sounds };
})();
